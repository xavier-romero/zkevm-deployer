...
export ZKEVM_SEQSENDER=hermeznetwork/zkevm-sequence-sender:v0.2.0-RC5
export ZKEVM_AGGREGATOR=hermeznetwork/zkevm-aggregator:v0.0.2-RC33
...
ZKEVM_SEQSENDER=$ZKEVM_SEQSENDER
ZKEVM_AGGREGATOR=$ZKEVM_AGGREGATOR
L1_EP=$L1_EP
